...
import com.wit.smartcar.blue.SampleGattAttributes;
...
public class BluetoothLeService extends Service {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothLeService.this
                        .getWorkableGattServices(getSupportedGattServices());
            } else {
    ...
    public boolean writeByes(byte[] bytes) {
        if (mNotifyCharacteristic != null) {
            ...
            boolean isTrue = mBluetoothGatt.writeCharacteristic(mNotifyCharacteristic);
            Log.d("wnw",isTrue+"");
            return isTrue;
        } else {
